#!/usr/bin/env python3
"""Run the V2 daily user-base review at most once per local day."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Run the V2 daily user-base review at most once per local day.")
    ...
    result = run_daily_user_base_review_cycle(
        args.db_path,
        args.output_dir,
