#!/usr/bin/env python3
"""Run the V2 daily per-user signal review batch at most once per local day."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Run the V2 daily per-user signal review batch at most once per local day.")
    ...
    result = run_daily_signal_review_cycle(
        args.db_path,
        args.output_dir,
