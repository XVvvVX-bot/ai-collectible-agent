#!/usr/bin/env python3
"""Build a V2 interest-level review report."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Build a V2 interest-level review report.")
    ...
    result = build_interest_review_report(args.db_path, args.output_dir, user_id=args.user_id)
    print(
        json.dumps(
            {
                "ok": True,
